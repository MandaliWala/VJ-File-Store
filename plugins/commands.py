...
# Ask Doubt on telegram @KingVJ01
    ...
    if data.split("-", 1)[0] == "verify":
        ...
        if AUTO_DELETE_MODE == True:
            k = await client.send_message(chat_id = message.from_user.id, text=f"<b><blockquote>Note ‣</blockquote></b>\n<b>Your above messages will be automatically deleted in <code>{AUTO_DELETE} minutes</code>. Please save them somewhere..!</b>")
